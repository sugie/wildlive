...
- **DB:** PostgreSQL 17 (via `pgvector/pgvector:pg17`) locally and in CI; the same major version and pgvector line as WildLive's production PostgreSQL cluster. Standardisation fixed by [`docs/adr/0005-postgresql-17-restandardization.md`](docs/adr/0005-postgresql-17-restandardization.md) (supersedes [`docs/adr/0004-postgresql-15-standardization.md`](docs/adr/0004-postgresql-15-standardization.md)). Bumping the major version requires a new ADR.
